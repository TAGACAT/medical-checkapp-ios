//
//  TestNextDetailViewController.m
//  NewMedicalApp
//
//
//
...
@interface TestNextDetailViewController ()

@end

@implementation TestNextDetailViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@   -    %@ %@", [OSP_DateManager CambiaFechaA24Horas:objNoti.fechaHora ConFormato:@""], objNoti.dosis, objNoti.test.unit1];
